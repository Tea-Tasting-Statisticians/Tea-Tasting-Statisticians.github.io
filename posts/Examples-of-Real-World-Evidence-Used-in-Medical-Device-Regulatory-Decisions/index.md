---
title: Examples of Real-World Evidence Used in Medical Device Regulatory Decisions
...
- [요약 (Executive Summary)](#1-요약-executive-summary)
- [소개 (Introduction)](#2-소개-introduction)
- [예시 표 읽는 방법](#3-예시-표-읽는-방법)
- [표 구성 요소 및 하위 요소 설명](#4-표-구성-요소-및-하위-요소-설명)
- [섹션 I. 의무기록 활용 사례 (예시 1–28)](#섹션-i-의무기록을-실세계-데이터-원천으로-활용한-사례)
- [섹션 II. 레지스트리 활용 사례 (예시 29–47)](#섹션-ii-레지스트리를-실세계-데이터-원천으로-활용한-사례)
- [섹션 III. 의무기록+레지스트리 병용 사례 (예시 48–53)](#섹션-iii-의무기록과-레지스트리를-병용한-사례)
- [섹션 IV. 행정 청구 데이터 활용 사례 (예시 54–55)](#섹션-iv-행정-청구-데이터를-활용한-사례)
- [섹션 V. 레지스트리+행정 청구 데이터 병용 사례 (예시 56–59)](#섹션-v-레지스트리와-행정-청구-데이터를-병용한-사례)
- [섹션 VI. 공중보건 감시 데이터 활용 사례 (예시 60–62)](#섹션-vi-공중보건-감시-데이터를-활용한-사례)
- [섹션 VII. 기기 생성 데이터 활용 사례 (예시 63–66)](#섹션-vii-기기-생성-데이터를-활용한-사례)
- [섹션 VIII. 복합 RWD 원천 활용 사례 (예시 67–68)](#섹션-viii-복합-rwd-원천을-활용한-사례)
- [섹션 IX. 체외진단(IVD) 관련 RWD 활용 사례 (예시 69–73)](#섹션-ix-체외진단ivd에-실세계-데이터를-활용한-사례)
- [규제적 시사점 종합](#규제적-시사점-종합)

***

## 1. 요약 (Executive Summary)

이 보고서는 회계연도(FY) 2020–2025의 시장 허가 사례 중 실세계 근거(Real-World Evidence, RWE)를 활용한 **73개의 사례**를 제시한다. 이는 FY 2012–2019의 90개 사례를 정리한 2021년 선행 보고서 『의료기기 규제 결정에 활용된 실세계 근거 사례(Examples of Real-World Evidence Used in Medical Device Regulatory Decisions)』의 연속 작업이다.
...
- **신규 기기 및 적응증 확대를 위한 1차 임상 근거 원천**으로서 RWE 활용
- **다른 임상 근거를 보완하는 보충적 임상 근거**로서 RWE 활용
- 기기 성능 평가를 위한 **외부 대조군 또는 역사적 대조군** 생성에 RWD 활용
- **시판 전·후 요구 사항을 모두 충족**하는 전체 제품 수명주기에 걸친 RWD 활용
